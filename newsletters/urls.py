...
urlpatterns += [
    ...
    path('u/creator/newsletter', views.user_creator_newsletter, name='user_creator_newsletter'),
    path('u/joined/newsletter', views.user_joined_newsletter, name='user_joined_newsletter'),
